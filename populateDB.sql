...
('Нерода Дмитрий Александрович', '1982-05-09', 'male', 'Neroda.D@inagro.com.ua', 'd.ramoss'),
('Кравец Aндрей Евгеньевич', '1975-01-14', 'male', 'Kravets.A@inagro.com.ua', 'acrom_sc'),
('Спивак Галина Владимировна', '1972-07-12', 'female', 'Spivak.G@inagro.com.ua', 'gala_spivak'),
('Демченко Богдан Александрович', '1992-11-13', 'male', 'demchenko.b@ukr.net', 'bogdan_d6'),
('Гузий Анна Александровна', '1984-07-08', 'female', 'anna_guzii@ukr.net', 'anna_guzii'),
('Онищенко Елена Ивановна', '1990-01-02', 'female', 'onishchenko.l@inagro.com.ua', 'lena.stadnik32');
...
('КУП Агро', '', 1, 3),
('Квартал', '', 2, 4),
('Управління АГРО-бізнесом для України', '', 2, 4);
